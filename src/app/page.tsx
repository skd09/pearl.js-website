...
const packages = [
  ...
  { name: 'database', accent: '#d29922', desc: 'Drizzle ORM — Postgres, MySQL, SQLite integration',              ver: '0.2.0' },
  ...
  { name: 'mail',     accent: '#79c0ff', desc: 'Nodemailer-powered mailable classes, transports, queue support', ver: '0.2.0' },
